# EDTH-Warsaw
This repository consist of my codebase for the Hackathon hosted by European Defense Tech Hub (EDTH) at Warsaw. We aim to build AI-powered drones for defense.
